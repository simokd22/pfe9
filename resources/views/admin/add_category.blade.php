...
<div class="container">
  <header>
   ...
   <form method="POST" action="{{route('Categories.store')}}">{{-- guessScrapingElements --}}{{-- news.store --}}
      @csrf
...
<div class="col-md-6">
   ...
   <input type="text" class="form-control" placeholder="Catégorie"  name="Categorie" aria-label="Categorie" aria-describedby="Categorie" required>
 </div>
